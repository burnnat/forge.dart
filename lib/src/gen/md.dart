...
class DigestAlgorithm extends jsw.TypedJsObject {
  static DigestAlgorithm $wrap(js.JsObject jsObject) => jsObject == null ? null : new DigestAlgorithm.fromJsObject(jsObject);
  DigestAlgorithm.fromJsObject(js.JsObject jsObject)
      : super.fromJsObject(jsObject);
  Digest create() => Digest.$wrap($unsafe.callMethod('create'));
}

class Digest extends jsw.TypedJsObject {
  static Digest $wrap(js.JsObject jsObject) => jsObject == null ? null : new Digest.fromJsObject(jsObject);
  Digest.fromJsObject(js.JsObject jsObject)
      : super.fromJsObject(jsObject);
